...
with tf.Session() as sess:
    ...
    saver = tf.train.import_meta_graph('/home/dmclass/yxj/data/modelxy/model.ckpt.meta')
    saver.restore(sess,tf.train.latest_checkpoint('/home/dmclass/yxj/data/modelxy/'))
